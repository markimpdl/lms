...
/**
 * Reset de senha feito pelo professor (E4-05) — Português.
 *
 * Contrato igual ao password_reset_by_admin.pt.php: recebe $data com
 * email, password, login_url; retorna {subject, html, text}.
 */

/** @var array{email:string,password:string,login_url:string} $data */

$email    = htmlspecialchars($data['email'],     ENT_QUOTES, 'UTF-8');
$password = htmlspecialchars($data['password'],  ENT_QUOTES, 'UTF-8');
$loginUrl = htmlspecialchars($data['login_url'], ENT_QUOTES, 'UTF-8');

$subject = 'LMS — sua senha foi redefinida pelo professor';

$html = <<<HTML
<!doctype html>
<html><body style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;padding:1rem">
    <p>Olá!</p>
    <p>Seu professor redefiniu sua senha na plataforma LMS. Use as credenciais abaixo para entrar:</p>
    ...
    <p style="color:#6c757d;font-size:.9rem">Se você não pediu este reset, avise seu professor imediatamente.</p>
    <hr>
...
Seu professor redefiniu sua senha na plataforma LMS. Use as credenciais
abaixo para entrar:
...
Se você não pediu este reset, avise seu professor imediatamente.
