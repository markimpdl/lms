...
/**
 * Teacher-triggered password reset (E4-05) — English.
...
$subject = 'LMS — your password has been reset by your teacher';

$html = <<<HTML
<!doctype html>
<html><body style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;padding:1rem">
    <p>Hello!</p>
    <p>Your teacher has reset your password on the LMS platform. Use the credentials below to log in:</p>
    ...
    <p style="color:#6c757d;font-size:.9rem">If you did not request this reset, contact your teacher immediately.</p>
    <hr>
...
Your teacher has reset your password on the LMS platform. Use the
...
If you did not request this reset, contact your teacher immediately.
