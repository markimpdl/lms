...
HTML,
    ...
    'html_after' => <<<'HTML'
        ...
        <tr><td style="padding:16px 24px;border-top:1px solid #F3F4F6;background:#FAFAFA;color:#6B7280;font-size:12px;line-height:1.5;">
          This message was sent automatically by your teacher's LMS platform. Please do not reply to this address.
        </td></tr>
      </table>
    </td></tr>
  </table>
...
HTML,
    ...
    'text_after'  => "\n\n--\nThis message was sent automatically by your teacher's LMS platform. Please do not reply.",
];
