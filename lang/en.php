...
return [
    ...
    'content.images.rehosted'      => ':count image(s) came from another unit and now belong to this one — every student can see them.',
    'content.images.rehost_failed' => ':count image(s) point to an attachment that is no longer available (deleted, or owned by another teacher). Students cannot see them: upload the image again in the editor.',
    'content.images.rehost_limit'  => ':count image(s) from another unit could not be brought over: this unit reached the cap of :max attachments. Delete an unused attachment and save again.',
    ...
    'submissions.nav.back'              => 'Back',
    'submissions.nav.forward'           => 'Next',
    ...
    'sidebar.rail.aria'              => 'Student shortcuts',
    'track.nav.next'                 => 'Next',
