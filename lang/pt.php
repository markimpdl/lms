...
return [
    ...
    'courses.action.duplicate'     => 'Duplicar',
    ...
    'cc.action.copy'      => 'Copiar para outro curso',
    ...
    'cu.action.copy'      => 'Copiar para outra Core Competence',
    ...
    // E31 — Cópia de conteúdo (F22 / ADR-034)
    'courses.duplicate.title'      => 'Duplicar curso',
    'courses.duplicate.confirm'    => 'Tem certeza que quer duplicar o curso',
    'courses.duplicate.hint'       => 'Uma cópia independente será criada (conteúdo, atividades, avaliações e arquivos). Alunos, matrículas, entregas e notas NÃO são copiados.',
    'courses.duplicated'           => 'Curso ":name" duplicado. Você está vendo a cópia.',
    'courses.err.duplicate_failed' => 'Não foi possível duplicar o curso. Tente novamente.',
    'cc.copy.title'       => 'Copiar Core Competence',
    'cc.copy.intro'       => 'Copiar para outro curso a Core Competence',
    'cc.copied'           => 'Core Competence ":name" copiada para ":course".',
    'cu.copy.title'       => 'Copiar Competence Unit',
    'cu.copy.intro'       => 'Copiar para outra Core Competence a Competence Unit',
    'cu.copied'           => 'Competence Unit ":name" copiada para ":cc".',
    'copy.target_course'  => 'Curso de destino',
    'copy.target_cc'      => 'Core Competence de destino',
    'copy.hint'           => 'Uma cópia independente será criada no destino — editá-la não afeta a origem.',
    'copy.no_targets'     => 'Você não tem outro curso disponível como destino.',
    'copy.no_targets_cu'  => 'Você não tem nenhuma Core Competence disponível como destino. Crie uma Core Competence primeiro.',
    'copy.err.target_invalid'  => 'Destino inválido ou indisponível.',
    ...
    'content.images.rehosted'      => ':count imagem(ns) vinha(m) de outra unidade e agora pertence(m) a esta — todos os alunos conseguem vê-la(s).',
    'content.images.rehost_failed' => ':count imagem(ns) aponta(m) para um anexo que não está mais disponível (apagado, ou de outro professor). Os alunos não conseguem vê-la(s): reenvie a imagem pelo editor.',
    'content.images.rehost_limit'  => ':count imagem(ns) de outra unidade não pôde(ram) ser trazida(s): esta unidade chegou ao teto de :max anexos. Apague algum anexo sem uso e salve de novo.',
    ...
    'attachments.section_hint'              => 'Arquivos de apoio (PDF, ZIP, TXT) e imagens para inserir no texto. Limite de 12 MB por arquivo.',
    'attachments.upload_label'              => 'Selecionar arquivo',
    'attachments.upload_hint'               => 'Aceitos: PDF, ZIP, TXT, PNG, JPG, GIF, WEBP. Máximo 12 MB.',
    ...
    'attachments.err.size'                  => 'Arquivo maior que 12 MB — selecione outro menor.',
    ...
    'activities.form.pdf'               => 'Arquivo do enunciado (PDF/ZIP)',
    'activities.form.pdf_hint'          => 'Opcional. PDF ou ZIP, máximo :mb MB. Só atividade tipo Projeto.',
    'activities.form.pdf_keep_hint'     => 'Deixe em branco para manter o arquivo atual.',
    'activities.form.pdf_current'       => 'Arquivo atual',
    'activities.form.pdf_remove'        => 'Remover arquivo atual',
    'activities.err.brief_size'         => 'Arquivo maior que o limite permitido.',
    'activities.err.brief_mime'         => 'O arquivo precisa ser PDF ou ZIP.',
    'activities.err.brief_no_file'      => 'Nenhum arquivo foi enviado.',
    'activities.err.brief_generic'      => 'Não foi possível salvar o arquivo. Tente novamente.',
    'activities.student.brief_title'    => 'Material da atividade',
    'activities.student.brief_hint'     => 'O professor anexou um arquivo (PDF ou ZIP) com o enunciado completo.',
    'activities.student.brief_download' => 'Baixar arquivo',
    ...
    // Conclusão manual (v0.31.0) — botão "Marcar como concluído"
    'manual_completion.section.title'      => 'Conclusão manual',
    'manual_completion.section.help'       => 'Quando habilitada, em vez da avaliação o aluno encerra esta unidade clicando em "Marcar como concluído" e ganha o XP definido. Mutuamente exclusivo com avaliação.',
    'manual_completion.toggle_label'       => 'Habilitar botão "Marcar como concluído"',
    'manual_completion.xp_label'           => 'XP da conclusão',
    'manual_completion.badge.enabled'      => 'Habilitado',
    'manual_completion.locked_by_evaluation' => 'Esta CU já tem avaliação cadastrada. Para usar o botão de conclusão manual, exclua a avaliação primeiro.',
    'manual_completion.enabled'            => 'Conclusão manual habilitada.',
    'manual_completion.disabled'           => 'Conclusão manual desabilitada.',
    'manual_completion.err.has_evaluation' => 'Não é possível habilitar: já existe avaliação na CU.',
    'manual_completion.err.activities_pending' => 'Conclua todas as atividades antes de marcar a unidade como concluída.',
    'manual_completion.completed'          => 'Unidade concluída! Próxima etapa liberada.',
    'manual_completion.student.title'         => 'Marcar unidade como concluída',
    'manual_completion.student.ready'         => 'Tudo pronto. Clique no botão abaixo para encerrar esta unidade e liberar a próxima.',
    'manual_completion.student.activities_pending' => 'Conclua todas as atividades acima para liberar o botão.',
    'manual_completion.student.cta'           => 'Marcar como concluído',
    'manual_completion.student.completed_title' => 'Unidade concluída',
    'manual_completion.student.completed_at'    => 'Encerrada em :when',
    ...
    'evaluations.empty_manual_active'   => 'Esta CU usa conclusão manual em vez de avaliação. Desabilite a conclusão manual acima para criar uma avaliação.',
    'evaluations.err.manual_completion_active' => 'Não é possível criar avaliação enquanto a conclusão manual estiver habilitada.',
    ...
    'submissions.run.no_stdin_hint'     => 'O <strong>Executar</strong> roda seu código sem entrada interativa — chamadas como :fn ficam travadas esperando algo que nunca chega. Para testar, atribua os valores diretamente às variáveis.',
    ...
    'evaluations.student.form.file_hint' => 'Aceitos: PDF, ZIP, TXT. Máximo 10 MB.',
    ...
    'evaluations.student.resubmitted'    => 'Nova tentativa enviada (substitui a anterior).',
    ...
    'evaluations.student.err.size'       => 'Arquivo maior que 10 MB.',
    ...
    'submissions.form.file_hint'        => 'Aceitos: PDF, ZIP, TXT. Máximo 10 MB.',
    'submissions.form.file_hint_dynamic' => 'Aceitos: :exts. Máximo 10 MB.',
    ...
    'submissions.nav.back'              => 'Voltar',
    'submissions.nav.forward'           => 'Avançar',
    ...
    'students.filter.period_label'   => 'Período do tempo online',
    'students.filter.period_all'     => 'Tudo',
    'students.filter.period_7d'      => '7 dias',
    'students.filter.period_30d'     => '30 dias',
    'students.filter.period_90d'     => '90 dias',
    ...
    // Tempo online — card "Atividade na plataforma" no detalhe do aluno (TIME-05).
    'students.activity.title'          => 'Atividade na plataforma',
    'students.activity.subtitle'       => 'Resumo do tempo online; sessão em curso aparece com indicador AO VIVO.',
    'students.activity.empty'          => 'Nenhuma sessão registrada ainda.',
    'students.activity.col.started_at' => 'Início',
    'students.activity.col.duration'   => 'Duração',
    'students.activity.col.ip'         => 'IP',
    'students.activity.col.device'     => 'Dispositivo',
    'students.activity.live'           => 'AO VIVO',
    'students.activity.load_more'      => 'Ver mais',
    ...
    'students.col.last_access'       => 'Último acesso',
    'students.col.access_count'      => 'Acessos',
    'students.col.time_total'        => 'Tempo total',
    'students.col.time_avg'          => 'Tempo médio',
    ...
    'dashboard.teacher.widgets_hint'  => 'Mini-apps interativas (zip HTML+JS) pra inserir no conteúdo das unidades.',
    ...
    'track.type.lesson'              => 'Lição',
    'track.type.activity'            => 'Exercício',
    'track.type.evaluation'          => 'Avaliação',
    'track.badge.draft'              => 'Rascunho',
    'track.badge.always_last'        => 'Sempre no fim',
    'track.badge.xp'                 => ':xp XP',
    'track.reorder_hint'             => 'Arraste pela alça ☰ para reordenar, ou use as setas. A avaliação fica sempre no fim.',
    'track.drag_title'               => 'Arraste para reordenar',
    'track.move_up'                  => 'Mover para cima',
    'track.move_down'                => 'Mover para baixo',
    'track.save_order'               => 'Salvar ordem',
    'track.flash.reordered'          => 'Ordem da trilha salva.',
    'track.err.invalid'              => 'Não foi possível reordenar. Recarregue a página e tente de novo.',
    ...
    'sidebar.rail.aria'              => 'Atalhos do aluno',
    'track.nav.next'                 => 'Próximo',
    'track.lesson.done'              => 'Concluída',
    'track.lesson.undo'              => 'Desfazer',
    'track.lesson.complete'          => 'Marcar como concluída',
    'track.lesson.complete_and_continue' => 'Concluir e continuar',
    'track.flash.completed'          => 'Lição concluída!',
    'track.flash.completed_xp'       => 'Lição concluída! +:xp XP',
    'track.flash.uncompleted'        => 'Conclusão desfeita. O XP desta lição foi removido.',
    'lessons.new.title'              => 'Nova lição',
    'lessons.new.button'             => 'Nova lição',
    'lessons.edit.title'             => 'Editar lição',
    'lessons.form.title'             => 'Título da lição',
    'lessons.form.content'           => 'Conteúdo',
    'lessons.form.xp_value'          => 'XP ao concluir',
    'lessons.form.xp_value.help'     => 'Pontos que o aluno ganha ao marcar a lição como concluída. 0 = sem XP.',
    'lessons.form.published'         => 'Publicar lição',
    'lessons.form.published.help'    => 'Enquanto não publicada, a lição fica como rascunho e o aluno não a vê.',
    'lessons.form.create'            => 'Criar lição',
    'lessons.form.err.title'         => 'O título precisa ter entre 3 e 200 caracteres.',
    'lessons.form.err.xp_value'      => 'O XP não pode ser negativo.',
    'lessons.delete.button'          => 'Excluir lição',
    'lessons.delete.count_completions' => ':count aluno(s) já concluíram esta lição — o XP creditado será removido.',
    'lessons.flash.created'          => 'Lição criada.',
    'lessons.flash.saved'            => 'Lição salva.',
    'lessons.flash.deleted'          => 'Lição ":title" excluída.',
    'lessons.err.not_v2'             => 'Este curso usa o formato clássico — lições existem apenas no formato trilha.',
    ...
    // Widgets interativos (F26/E35 — ADR-037)
    'widgets.title'                  => 'Widgets',
    'widgets.subtitle'              => 'Mini-apps interativas pra inserir no conteúdo das unidades.',
    'widgets.new_button'           => 'Novo widget',
    'widgets.new_title'            => 'Novo widget',
    'widgets.edit_title'           => 'Editar widget — :name',
    'widgets.edit_breadcrumb'      => 'Editar',
    'widgets.empty.title'          => 'Você ainda não tem widgets.',
    'widgets.empty.hint'           => 'Suba um .zip com index.html (HTML+CSS+JS) e insira no conteúdo das unidades.',
    'widgets.entry'                => 'Entrada',
    'widgets.inactive'             => 'Inativo',
    'widgets.mode.inline'          => 'Embutido',
    'widgets.mode.window'          => 'Nova janela',
    'widgets.mode.inline_hint'     => 'renderiza dentro do conteúdo',
    'widgets.mode.window_hint'     => 'aparece como ícone e abre em nova janela',
    'widgets.action.preview'       => 'Pré-visualizar',
    'widgets.delete_confirm'       => 'Remover o widget ":name"? Onde estiver inserido, deixará de aparecer.',
    'widgets.created'              => 'Widget ":name" criado.',
    'widgets.updated'             => 'Widget ":name" atualizado.',
    'widgets.deleted'             => 'Widget ":name" removido.',
    'widgets.unavailable'        => 'Widget indisponível.',
    'widgets.print_placeholder'  => 'Widget interativo: :name (veja online).',
    'widgets.field.name'          => 'Nome',
    'widgets.field.render_mode'   => 'Como aparece no conteúdo',
    'widgets.field.zip'           => 'Arquivo .zip do widget',
    'widgets.field.zip_optional'  => 'opcional — deixe vazio pra manter o atual',
    'widgets.field.zip_hint'      => 'Zip com index.html na raiz (HTML/CSS/JS/imagens). Máx. :mb MB.',
    'widgets.field.icon'          => 'Ícone (modo nova janela)',
    'widgets.field.icon_hint'     => 'Caminho de uma imagem dentro do zip (ex.: icon.png). Opcional.',
    'widgets.field.height'        => 'Altura (px)',
    'widgets.field.height_hint'   => 'modo embutido',
    'widgets.insert.button'       => 'Inserir widget',
    'widgets.insert.title'        => 'Inserir widget',
    'widgets.insert.field'        => 'Widget',
    'widgets.insert.none'         => 'Nenhum widget disponível neste curso. Cadastre em Widgets.',
    'widgets.err.name'            => 'O nome deve ter entre 3 e 120 caracteres.',
    'widgets.err.zip_required'    => 'Envie o arquivo .zip do widget.',
    'widgets.err.upload'          => 'Falha no upload do arquivo.',
    'widgets.err.size'            => 'Arquivo grande demais.',
    'widgets.err.not_zip'         => 'O arquivo precisa ser um .zip válido.',
    'widgets.err.unsafe_path'     => 'O zip contém caminhos inválidos.',
    'widgets.err.ext'             => 'O zip contém um tipo de arquivo não permitido.',
    'widgets.err.no_entry'        => 'O zip precisa ter um index.html na raiz.',
    'widgets.err.empty'           => 'O zip está vazio.',
    'widgets.err.generic'         => 'Não foi possível processar o widget.',
