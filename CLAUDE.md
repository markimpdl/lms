...
- **Backend:** PHP **8.3** (produção na Hostinger roda em 8.3 — features 8.3 OK: typed class constants, `json_validate`, `#[Override]`. **Não usar features de 8.4**: property hooks, asymmetric visibility) — sem framework
